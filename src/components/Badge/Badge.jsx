...
const Badge = ({id, name, image, price, inCart}) => {
        ...
        <div className="badge" key={name + "123"}>
            ...
            <div className="badge__body">
                ...
                <div className="badge__actions">
                    <div 
                    className={inCart ? "badge__button badge__button--added" : "badge__button"} 
                    onClick={addBadgeToBasket}>{inCart ? "Добавлено!" : "В корзину"}</div>
